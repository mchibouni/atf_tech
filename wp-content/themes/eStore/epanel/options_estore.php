	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Currency Sign",
                   ...
                   "std" => "$",
                   "type" => "text",
				   "desc" => "Place the currency symbol you would like to display here. "),
			...
			array( "name" => "Cufon Font Replacement",
				   ...
				   "type" => "checkbox2",
				   "std" => "on",
				   "desc" => "Here you can choose to display Cufon Font. "),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Display 'Deals Of The Day'",
                   ...
                   "type" => "checkbox",
				   "std" => "on",
				   "desc" => "Here you can choose to display the Deals Of The Day on the homepage. "),
